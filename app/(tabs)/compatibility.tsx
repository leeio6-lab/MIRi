...
const st = StyleSheet.create({
  ...
  heroDot: { width: 3.5, height: 3.5, borderRadius: 2, backgroundColor: '#2B2A29' },
  heroDotSmall: { width: 2, height: 2, borderRadius: 1, backgroundColor: '#2B2A29', opacity: 0.4 },
  ...
  calToggleActive: { backgroundColor: '#2B2A29' },
  ...
  genderActive: { backgroundColor: '#2B2A29', borderColor: '#1A1A1A' },
