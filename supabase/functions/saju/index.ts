...

{
  ...
  "overview": {
    "_tone": "🔥 overview는 이 앱의 바이럴 핵심이다. 읽은 사람이 '이거 완전 나인데...' 하고 캡처→카톡/인스타 스토리에 올리는 수준. ⚡ 문체: 반말 단정문. 위트 있되 품격 있게. 가볍지도 무겁지도 않은 절묘한 톤. 센스 있는 친구가 정곡을 찌르는 느낌. ⛔ 금지: ~해요/~습니다/~하는 체질/~하는 경향/물음표(?)/ㅋㅋ/ㅎㅎ/이모지/진지한 상담사 말투. ✅ 긍정(자랑하고 싶은 것) 50% + 부정(찔리는 것) 50%. 매 항목이 읽는 사람이 멈칫할 정도로 정확해야 한다.",
    "poeticTitle": "인스타 프로필에 바로 박을 킬러 별명. 반말. 이 사주만의 핵심을 웃기거나 소름돋게 한 방에. 예시 복사 금지, 창작. (급: '읽씹 3분 만에 후회 카톡 보내는 인간', '퇴사 각서 매달 쓰면서 연봉 협상은 꼬박꼬박', '타고난 인복으로 먹고사는 럭키가이', '혼자 다 하는 원맨팀 근데 외로움은 못 참음') 15~25자.",
    "hookQuestion": "poeticTitle이 사실인 증거. 반말 단정문. 물음표 금지. 어제 실제로 한 행동처럼 구체적이고 생생하게. (급: '어제도 새벽 2시에 갑자기 자격증 검색하다 잠들었다', '방금 회의에서 핵심 한 마디로 분위기 뒤집어놓았다', '오늘도 참다가 퇴근길에 혼자 씩씩거렸다') 20~40자.",
    "personality": "성격 팩폭 or 자랑. 반말. 읽고 ㅋㅋㅋ 하거나 소름. (급: '착한 게 아니라 싸우기 귀찮은 것뿐인 평화주의자', '칭찬 한 마디에 일주일 사는 인정 중독자', '한번 꽂히면 밤새 파는 미친 집중력 보유자') 20~35자.",
    "career": "직업 팩폭 or 자랑. 반말. (급: '능력은 팀장급인데 눈치값에 깎여서 사원 마인드', '맡기면 무조건 해내는 원맨팀, 번아웃도 혼자 감당', '뭘 해도 결국 인정받는 타고난 프로') 20~35자.",
    "wealth": "돈 팩폭 or 자랑. 반말. (급: '월급날 쿠팡 3건 결제하는 통장 학대범', '한 번 돈맛 보면 무서울 정도로 집중하는 재물 사냥꾼', '안 쓰는 것 같은데 모으면 제일 많은 은근 부자 타입') 20~35자.",
    "love": "연애 팩폭 or 자랑. 반말. (급: '좋아하면 올인, 근데 먼저 고백은 죽어도 안 하는 비겁러', '한번 빠지면 세상이 그 사람밖에 안 보이는 극한 몰입러', '사귀면 세상에서 제일 잘해주는 연인감') 20~35자.",
    "health": "건강 팩폭 or 자랑. 반말. (급: '새벽 2시 라면 끓이면서 건강 유튜브 보는 모순 인간', '타고난 체력으로 무리해도 버티는데 그게 오히려 독', '한번 운동 시작하면 미친 듯이 빠지는 올인러') 20~35자.",
    "family": "가족 팩폭 or 자랑. 반말. (급: '엄마 전화 씹다가 죄책감에 30분 뒤 콜백하는 루틴', '가족한테 욕 먹어도 결국 다 해주는 숨은 효자', '표현은 서툰데 기념일은 절대 안 까먹는 다정이') 20~35자.",
    "social": "인간관계 팩폭 or 자랑. 반말. (급: '혼자가 편한데 초대 안 오면 서운한 관종 내향인', '처음 보는 사람도 5분이면 절친으로 만드는 인싸력', '험담 듣고도 웃으면서 밥 같이 먹는 프로 대인배') 20~35자.",
    "yearly": "올해 한 줄 예언. 반말. 긴장 or 기대. (급: '올 하반기, 참았던 게 터진다 — 좋든 나쁘든', '올해 내린 결정 하나가 3년을 좌우한다', '올해는 잃는 게 아니라 비우는 해다') 20~35자.",
    "lifePeak": "인생 그래프 핵심. 반말. 나이 고려. (급: '진짜 전성기는 아직 안 왔다, 기다려', '지금이 바닥이다, 여기서부터 올라간다', '40대에 터지니까 지금은 씨 뿌리는 시간') 20~35자.",
    "lifeDirection": "인생 방향 한 줄. 반말 명령문. 액자에 넣고 싶은 급. (급: '남들 따라가지 마, 네 길은 아무도 안 간 쪽에 있다', '불처럼 태워, 중간은 네 자리가 아니다', '멈추지 마, 네가 쉬는 동안 운이 지나간다') 20~35자.",
