...

{
  ...
  "overview": {
    "_tone": "🔥 MIRI 바이럴 핵심. 캡처→카톡/인스타 공유 목표. 톤: 친한 형/누나가 술자리에서 정곡 찌르는 팩폭. 웃기면서 찔리는 게 최고. ⚡ 문체: 축약형 반말. '~함/~씀/~임/~됨' 또는 명사로 툭 끊기. '~한다/~쓴다/~간다' 금지. 🚨 핵심 규칙: 모든 항목은 이 사주의 십신/합충/오행 구조에서만 도출. 형용사 금지, 구체적 행동으로 묘사. 프롬프트에 예시가 없으므로 100% 이 사주에 맞게 창작해야 함. 다른 사주에도 해당되는 범용 표현이면 실패. 같은 내용을 다른 사주에 붙여넣을 수 있으면 실패. ⛔ 금지: ~해요/~습니다/~한다/~하는 체질/~하는 경향/물음표/이모지/상담사 말투. ✅ 긍정 50% + 부정 50%.",
    "poeticTitle": "킬러 별명. 10~20자. 🚨 아래는 톤 참고용이지 복사 대상 아님. 반드시 이 사주의 구조에서 창작. (비겁 강한 사주→'혼자 다 하는 외로운 에이스', 식상 강한 사주→'입이 먼저 움직이는 아이디어 폭격기', 재성 강한 사주→'돈 냄새 귀신같이 맡는 현실주의자')",
    "hookQuestion": "poeticTitle의 증거. 축약형 반말. 물음표 금지. 15~25자. 🚨 톤 참고만. (관성 강→'또 혼자 야근하고 택시 탐', 식상 강→'회의에서 아이디어 3개 던지고 하나도 안 채택됨', 인성 강→'서점에서 2시간 서서 읽고 안 삼')",
    "personality": "성격 행동 묘사. 12~22자. 🚨 톤 참고만. (비겁 강→'지면 잠 못 자는 승부욕', 인성 강→'생각이 너무 많아서 행동이 느림', 식상 강→'말 시작하면 멈출 줄 모름')",
    "career": "직업 행동 묘사. 12~22자. 🚨 톤 참고만. (관성 강→'시키면 잘하는데 스스로는 못 움직임', 식상 강→'자기 사업이 체질, 조직은 답답', 재성 강→'돈 되는 일만 골라서 함')",
    "wealth": "돈 습관 묘사. 12~22자. 🚨 톤 참고만. 편재/정재 구분 필수. (편재 강→'한탕 노리다 날림', 정재 강→'천 원도 가계부에 적는 타입', 재성 약→'돈에 관심이 없어서 모이지도 않음')",
    "love": "연애 패턴 묘사. 12~22자. 🚨 톤 참고만. (관성 강→'타입 확실, 아니면 쳐다도 안 봄', 비겁 강→'연애도 주도권 싸움', 식상 강→'표현 과다로 상대 질리게 함')",
    "health": "건강 습관 묘사. 12~22자. 🚨 톤 참고만. (화 과다→'열 오르면 두통부터', 수 과다→'손발 차고 겨울이 적', 토 부족→'소화기가 만성 약점')",
    "family": "가족 관계 묘사. 12~22자. 🚨 톤 참고만. (인성 강→'부모 말이면 일단 들음', 비겁 강→'형제랑 은근 경쟁', 관성 강→'집에서도 규칙 세우는 타입')",
