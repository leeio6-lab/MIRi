...
□ 🚨 overview 12개 항목 중 '배달', '적금', '유튜브', '이직', '헬스', '이불킥', '읽씹' 등 범용 키워드가 2개 이상 들어가지 않았는가? (사주 근거 없는 범용 행동이면 실패)
□ 🚨 같은 프롬프트로 다른 사주를 분석했을 때 비슷한 결과가 나올 수 있는가? (나올 수 있으면 실패 — 반드시 이 사주의 간지에서만 도출)
...

{
  ...
  "overview": {
    ...
    "poeticTitle": "이 사주만의 킬러 별명. 10~20자. 🚨 반드시 이 사주의 십신/오행 구조에서 도출. 다른 사주에 붙여넣을 수 있으면 실패.",
    "hookQuestion": "poeticTitle의 증거가 되는 구체적 행동 묘사. 물음표 금지. 15~25자. 🚨 이 사주의 간지 근거에서만 나올 수 있는 행동.",
    "personality": "이 사주의 비겁/식상/인성 배치에서 도출한 성격 행동 묘사. 12~22자.",
    "career": "이 사주의 관성/식상 배치에서 도출한 직업 행동 묘사. 12~22자.",
    "wealth": "이 사주의 재성(편재/정재) 구조에서 도출한 돈 습관 묘사. 12~22자. 🚨 편재 강하면 투기/충동형, 정재 강하면 저축/계획형 — 사주마다 완전히 다르게.",
    "love": "이 사주의 관성/재성/비겁 관계에서 도출한 연애 패턴 묘사. 12~22자.",
    "health": "이 사주의 오행 과다/부족에서 도출한 건강 습관 묘사. 12~22자.",
    "family": "이 사주의 인성/비겁 구조에서 도출한 가족 관계 묘사. 12~22자.",
    "social": "이 사주의 비겁/식상/관성에서 도출한 대인관계 묘사. 12~22자.",
    "yearly": "올해 세운과 원국의 작용에서 도출한 한 줄 예언. 12~25자.",
    "lifePeak": "대운 흐름에서 도출한 인생 피크 시점. 나이 고려 시제. 12~22자.",
    "lifeDirection": "용신 오행에서 도출한 인생 방향. 명령문 OK. 12~22자.",
