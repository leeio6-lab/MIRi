...

{
  ...
  "overview": {
    "_tone": "🔥 읽는 순간 심장이 쿵 하는 한 줄. 뼈 때리는 팩폭인데 억울하지 않고 웃김. 읽고 나서 캡처해서 친구한테 '이거 소름' 하고 보내는 수준. 레퍼런스: 에타 자기소개, 트위터 바이오, 무한도전 자막. ⚡ 종결: 반드시 종결형. 허용: ~임/~됨/~씀/~음/~짐/~중/명사끊기. ⛔ 금지 종결: ~한다/~된다/~있다/~없다/~간다 (하다체 전부). ⛔ 금지: ~해요/~습니다/물음표/이모지/~경향/~체질/설명체. 🚨 내용: 아래 상세 분석 결론을 이 톤으로 변환. 상세와 모순 시 전체 실패.",
    "poeticTitle": "이 인간 한 줄 정의. 10~20자. personality.core 결론에서. 듣는 사람이 '아 맞아 ㅋㅋㅋ' 할 수준. 종결형 or 명사끊기.",
    "hookQuestion": "poeticTitle의 증거. 구체적 상황 묘사. 15~25자. 종결형 필수. 물음표 금지. 톤 참고만: '새벽 2시에 보낸 카톡 후회하면서 또 보내는 중', '퇴근하고 집 앞인데 차에서 30분째 멍 때리는 중'",
    "personality": "personality.core 결론을 뼈 때리는 한 줄로. 12~22자. 종결형 필수. 톤 참고만: '착한 척하다가 뒤에서 속 터져서 혼자 삭힘', '자존심이 밥 먹여주는 줄 아는 인간임', '참다 참다 터지면 주변이 초토화됨'",
    "career": "career.analysis 결론을 한 줄로. 12~22자. 종결형 필수. 톤 참고만: '재능은 있는데 꾸준함이 3일 못 감', '남 밑에서 일하면 영혼이 빠져나감', '능력 대비 대우가 늘 아쉬운 팔자임'",
    "wealth": "wealth.pattern 결론을 한 줄로. 12~22자. 종결형 필수. 🚨 상세에서 '재성 약'→돈 관심 없는 방향. '편재 강'→한탕 방향. 정반대 쓰면 실패. 톤 참고만: '월급 들어오면 어디로 갔는지 모르는 통장 주인임', '돈 앞에서 이성이 증발하는 타입임', '아끼는 건 잘하는데 버는 재주가 없음'",
    "love": "love 결론을 한 줄로. 12~22자. 종결형 필수. 톤 참고만: '좋아하면 자다가도 벌떡 일어남', '이별 후 6개월은 폐인 확정임', '썸만 100번 타고 연애는 못 하는 중'",
    "health": "health 결론을 한 줄로. 12~22자. 종결형 필수. 오행 기반. 톤 참고만: '멘탈 나가면 몸이 바로 따라 무너짐', '위장이 스트레스 측정기임', '잠을 줄이면 제일 먼저 얼굴에 나옴'",
    "family": "family 결론을 한 줄로. 12~22자. 종결형 필수. 톤 참고만: '엄마한테 받은 상처를 아직도 꺼내 씀', '효도하고 싶은데 만나면 5분 만에 싸움', '가족이 제일 피곤한데 제일 신경 쓰임'",
    "social": "relationship 결론을 한 줄로. 12~22자. 종결형 필수. 톤 참고만: '인스타 팔로워 500인데 생일 축하 문자 3개 옴', '만나면 재밌는데 먼저 연락은 절대 안 함', '소수 정예인 척하는데 사실 그냥 귀찮은 거임'",
    "yearly": "올해 세운 결론을 한 줄로. 12~25자. 종결형 필수. 세운+원국 근거. 톤 참고만: '올해 참으면 내년에 두 배로 돌려받음', '상반기에 뿌린 게 하반기에 예상 못한 형태로 터짐', '올해 만난 인연 중 하나가 인생을 바꿔놓음'",
    "lifePeak": "인생 피크 한 줄. 12~22자. 종결형 필수. 나이 고려. 톤 참고만: '아직 진짜 전성기 안 왔음, 40대에 다 뒤집어짐', '이미 한번 터졌고 두 번째가 슬슬 오는 중임', '지금이 인생 하이라이트, 여기서 밀어야 됨'",
    "lifeDirection": "인생 방향 한마디. 12~22자. 종결형 필수. 톤 참고만: '계획대로 안 되는 게 오히려 정답인 팔자임', '남 눈치 보는 순간 다 꼬임', '느리더라도 내 속도로 가야 안 부서짐'",
    "hotKey": "위 10개 항목 중 가장 소름 돋는 항목 1개의 키."
  },
