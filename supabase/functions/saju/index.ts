...

{
  ...
  "overview": {
    "_tone": "각 항목 작성법: (1) 아래 상세 분석(personality.core, career.analysis 등)을 먼저 다 완성해. (2) 상세에서 이 사주만의 가장 핵심적인 결론을 하나 골라. (3) 그 결론을 아래 예시와 비슷한 톤으로 15~25자 구어체 문장으로 바꿔. (4) 예시 문장을 그대로 쓰면 실패. 예시는 톤 수준만 참고. 내용은 100% 이 사주의 상세 분석에서. (5) 같은 프롬프트로 10명을 돌렸을 때 3명 이상 비슷한 문장이 나오면 실패. 문체: 말하듯 툭 끊기. 물음표 금지. ~해요/~합니다/~한다/~임/~됨 금지. 종결 금지: ~하는 중, ~하는 인간, ~하는 타입, ~하는 사람. 상세와 overview가 모순되면 전체 실패.",
    "poeticTitle": "personality.core 결론에서 이 사람을 한 줄로. 8~18자. [톤 레벨 참고, 복사 금지] 火일간 비견 강한 사주→'괜찮다면서 혼자 끙끙', 水일간 식상 강한 사주→'말은 안 하는데 다 알고 있음'. 이 사주의 십신 구조에서 창작할 것.",
    "hookQuestion": "poeticTitle의 증거가 되는 구체적 행동 한 장면. 15~25자. 물음표 금지. [톤 레벨 참고, 복사 금지] '도와준다는데 괜찮다고 하고 결국 밤새 혼자 처리', '할 말 다 해놓고 집 가는 길에 후회 시작'. 이 사주의 상세 분석 속 행동에서 창작.",
    "personality": "personality.core에서 가장 찔리는 결론을 15~25자로. [톤 참고, 복사 금지] '지는 게 싫어서 양보하는 척하면서 속으로 점수 매기는 중', '착해 보이는데 속에 할 말 3년치 쌓아두고 있음'",
    "career": "career.analysis 결론을 15~25자로. [톤 참고, 복사 금지] '능력은 임원급인데 정치력이 0이라 만년 실무자', '시키면 잘하는데 왜 하는지 납득이 안 되면 손이 안 움직임'",
    "wealth": "wealth.pattern 결론을 15~25자로. 상세와 방향 반대면 실패. [톤 참고, 복사 금지] '아끼는 건 기가 막히는데 한 번 풀리면 브레이크 고장', '돈 벌 줄은 아는데 모아둘 줄을 모름'",
    "love": "love 결론을 15~25자로. [톤 참고, 복사 금지] '밀당 같은 거 못 하고 좋으면 얼굴에 다 써져 있음', '차이고 나서도 한 달은 카톡 프사 바꾸면서 눈치 봄'",
    "health": "health 결론을 15~25자로. 오행 기반. [톤 참고, 복사 금지] '화 삭이다가 결국 위장이 먼저 항복', '안 아픈 척하다가 한 번에 큰 병원행'",
    "family": "family 결론을 15~25자로. [톤 참고, 복사 금지] '집에선 제일 무뚝뚝한데 가족 생일은 절대 안 까먹음', '부모한테 서운한 거 있는데 말을 못 하고 10년째'",
    "social": "relationship 결론을 15~25자로. [톤 참고, 복사 금지] '만나면 분위기 메이커인데 집 가면 3일은 충전 필요', '연락 먼저 안 하는데 안 오면 서운해하는 모순'",
    "yearly": "올해 세운 결론을 15~25자로. 세운+원국 근거. [톤 참고, 복사 금지] '올 하반기에 그동안 눌렀던 게 하나 풀림', '올해는 벌기보다 지키는 게 더 중요한 해'",
    "lifePeak": "인생 피크를 15~25자로. 나이 고려. [톤 참고, 복사 금지] '진짜 본 게임은 43세부터 시작', '이미 한번 터졌고 두 번째 물결 오는 중'",
    "lifeDirection": "인생 방향을 15~25자로. [톤 참고, 복사 금지] '빨리 가려고 하면 할수록 꼬이는 팔자, 천천히 가야 됨', '혼자 결정해야 맞는 구조, 남 의견 들으면 흔들림'",
