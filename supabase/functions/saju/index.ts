...

{
  ...
  "overview": {
    ...
    "poeticTitle": "킬러 별명. 예시 복사 금지. (레벨 참고: '잔고 반토막 내는 인간', '뒷담 3년 기억하는 코끼리', '혼자 ppt 만드는 1인 시스템') 10~20자.",
    "hookQuestion": "poeticTitle의 증거. 축약형 반말. 물음표 금지. (레벨 참고: '어제도 유튜브에 2시간 바침', '점심 30분 고민하다 어제 거 또 시킴') 15~25자.",
    "personality": "성격 팩폭. 축약형 반말. 행동으로. (레벨 참고: '속으로 반박문 3개 작성 중', '1분 늦으면 짜증 폭발') 12~22자.",
    "career": "직업 팩폭. 축약형 반말. (레벨 참고: '퇴근 후 본인 프로젝트는 새벽까지', '이직 3년째 보류') 12~22자.",
    "wealth": "돈 팩폭. 축약형 반말. (레벨 참고: '적금 3개인데 배달비 월 20만', '불안형 저축러') 12~22자.",
    "love": "연애 팩폭. 축약형 반말. (레벨 참고: '썸은 밀당, 사귀면 올인', '좋아하면 말수 줄어드는 반전') 12~22자.",
    "health": "건강 팩폭. 축약형 반말. (레벨 참고: '헬스 등록 5번째, 한번 가면 2시간', '스트레스 = 새벽 라면') 12~22자.",
    "family": "가족 팩폭. 축약형 반말. (레벨 참고: '잔소리엔 무반응, 방에서 이불킥', '표현 서툰 숨은 효자') 12~22자.",
    "social": "인간관계 팩폭. 축약형 반말. (레벨 참고: '단톡 읽씹, 1:1은 새벽까지', '모임 후 복기하느라 지침') 12~22자.",
    "yearly": "올해 한 줄. 축약형 반말. (레벨 참고: '상반기에 하나 터짐, 본인 선택', '하반기 결정이 내년 수입 좌우') 12~25자.",
    "lifePeak": "인생 피크. 축약형 반말. 나이 고려. (레벨 참고: '진짜 전성기는 아직', '두 번째 피크가 50대에 옴') 12~22자.",
    "lifeDirection": "인생 방향. 명령문 OK. (레벨 참고: '무서운 쪽으로 가', '네 운은 사람에게서 옴') 12~22자.",
