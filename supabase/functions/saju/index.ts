...

{
  ...
  "overview": {
    "_tone": "모든 항목을 '반전 구조'로 써. 이게 위트의 핵심. 반전 구조 = 'A인데 B' 또는 'A하면서 B'. A와 B가 모순되거나 예상 밖이어야 함. personality 반전: 겉모습 vs 속마음, 말 vs 행동, 의도 vs 결과. career 반전: 능력 vs 대우, 야망 vs 현실, 열정 vs 지속력. wealth 반전: 벌기 vs 쓰기, 의지 vs 실행, 아끼기 vs 소비. love 반전: 이상 vs 현실, 겉 vs 속, 원하는 것 vs 하는 것. health 반전: 아는 것 vs 하는 것, 걱정 vs 관리. family 반전: 마음 vs 표현, 사랑 vs 충돌. social 반전: 겉관계 vs 속마음, 인싸 vs 외로움. 작성법: 1. 상세 분석에서 이 사주의 핵심 모순을 찾아. 사주에는 반드시 모순이 있음. 2. 그 모순을 'A인데 B' 한 문장으로 만들어. 3. A와 B에 구체적 행동/상황을 넣어. 10개 항목에 같은 단어 2번 이상 반복 금지. '~부족', '~주의', '~타입', '~사람', '~가능'으로 끝나면 0점. 물음표 금지. ~해요/~합니다/~한다/~임/~됨 금지. 문체: 구어체 툭 끊기. 15~28자.",
    "poeticTitle": "이 사주의 가장 큰 모순을 한 줄로. personality.core에서 도출. 8~18자.",
    "hookQuestion": "poeticTitle의 반전이 실제로 드러나는 구체적 장면. 15~28자. 물음표 금지.",
    "personality": "personality.core에서 겉모습과 속마음의 반전. 'A인데 B' 또는 'A하면서 B'. 15~28자.",
    "career": "career.analysis에서 능력과 현실의 반전. 15~28자.",
    "wealth": "wealth.pattern에서 돈에 대한 의지와 실행의 반전. 상세와 방향 반대면 실패. 15~28자.",
    "love": "love에서 원하는 것과 실제 행동의 반전. 15~28자.",
    "health": "health에서 아는 것과 하는 것의 반전. 15~28자.",
    "family": "family에서 마음과 표현의 반전. 15~28자.",
    "social": "relationship에서 겉관계와 속마음의 반전. 15~28자.",
    "yearly": "올해 세운에서 기대와 현실의 반전, 또는 전반기와 후반기의 반전. 15~28자.",
    "lifePeak": "인생 그래프에서 지금과 피크의 반전. 나이 고려. 15~28자.",
    "lifeDirection": "이 사주가 해야 하는 것과 하고 있는 것의 반전. 15~28자.",
    "hotKey": "위 항목 중 반전이 가장 강렬한 1개의 키."
  },
