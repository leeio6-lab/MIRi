...

{
  ...
  "overview": {
    "_tone": "overview는 명리 앱의 얼굴. 이거 재미없으면 앱 삭제. 작성법: 1. 아래 상세 분석을 먼저 다 쓴다. 2. 각 상세의 핵심 결론을 하나 고른다. 3. 그 결론을 아래 예시들과 같은 수준의 구체적이고 위트 있는 문장으로 바꾼다. 예시들을 보고 이 수준을 맞춰: '괜찮다고 해놓고 집 가서 이불킥', '회의에서 핵심 한마디로 정리해놓고 공은 팀장이 가져감', '월급 들어온 날 쿠팡 앱 열고 아 안 돼 하면서 결제 3건', '좋아하는 사람 앞에서만 말 더듬는 거 본인만 모름', '스트레스 받으면 배달앱 켜는 게 루틴', '엄마 전화 씹다가 30분 뒤에 죄책감 콜백', '약속 잡아놓고 당일 아침에 가기 싫은 거 1시간 고민'. 위 예시를 그대로 쓰는 게 아니라, 이 수준의 구체성+위트를 이 사주의 상세 분석 결론으로 만들어야 함. 차이: 실패='감정 표현이 서투름'(성격 설명) → 성공='고마운 건 알겠는데 고맙다는 말이 입에서 안 나와서 대신 밥 사줌'(행동 장면). 실패='돈은 잘 버는데 소비가 문제'(가계부 요약) → 성공='연봉 올랐는데 통장 잔고가 그대로인 거 보고 본인이 제일 놀람'(장면). 실패='친구 많지만 외로움'(심리상담 소견) → 성공='카톡방 30개인데 진짜 속얘기 할 사람은 0명'(구체적 숫자+상황). 모든 항목이 장면이 그려지고, 읽는 사람이 피식 웃거나 뜨끔해야 함. 문체: 구어체로 툭. 물음표 금지. ~해요/~합니다/~한다/~임/~됨/~하는 중/~하는 인간/~하는 타입 금지.",
    "poeticTitle": "이 사람을 한 줄로. personality.core에서 도출. 8~18자. 예시 수준: '괜찮다면서 혼자 끙끙', '입은 무거운데 속은 폭풍'. 이 수준으로 이 사주의 personality.core에서 만들어.",
    "hookQuestion": "poeticTitle이 사실인 증거 장면. 15~25자. 예시 수준: '어제도 할 말 삼키고 집에 와서 혼자 씩씩거림', '또 안 괜찮으면서 괜찮다고 해버림'. 이 수준으로 이 사주에서.",
    "personality": "personality.core에서 가장 찔리는 행동 장면. 15~25자. 실패: '속은 뜨겁고 말은 차갑게'. 성공: '화나면 말 안 하고 3일 씹다가 아무렇지 않은 척 먼저 연락'.",
    "career": "career.analysis에서 직장 행동 장면. 15~25자. 실패: '능력 있는데 표현이 부족해'. 성공: '기획서는 본인이 다 썼는데 발표는 팀장이 하고 박수받는 구조'.",
    "wealth": "wealth.pattern에서 돈 쓰는 장면. 15~25자. 상세와 방향 반대면 실패. 실패: '돈은 잘 버는데 소비가 문제'. 성공: '세일이라는 말에 장바구니 10개 담아놓고 고민하다 결국 다 결제'.",
    "love": "love에서 연애 행동 장면. 15~25자. 실패: '고백 못 하고 혼자 앓는 타입'. 성공: '좋아하는 사람 인스타 스토리 올리면 3초 만에 확인하면서 좋아요는 절대 안 누름'.",
    "health": "health에서 몸이 보내는 신호 장면. 15~25자. 실패: '화가 많아서 소화기 걱정됨'. 성공: '야근 3일차에 눈 밑 떨리기 시작하면 그게 한계 신호'.",
    "family": "family에서 가족과의 실제 장면. 15~25자. 실패: '가족에겐 무관심한 척하지만'. 성공: '명절에 엄마랑 10분 만에 언성 높아지는데 집 가는 길에 후회'.",
    "social": "relationship에서 친구관계 장면. 15~25자. 실패: '친구 많지만 외로움을 느낌'. 성공: '톡방 30개인데 새벽에 힘들 때 전화할 사람 고르다가 그냥 잠'.",
    "yearly": "올해 세운 결론을 올해 겪을 장면으로. 15~30자. 실패: '올해는 큰 변화보다 안정적'. 성공: '올 하반기에 안 하던 짓 하나 저지르는데 그게 오히려 전환점'.",
    "lifePeak": "인생 피크를 구체적으로. 15~25자. 나이 고려. 실패: '40대 초반에 큰 기회 옴'. 성공: '43세에 그동안 참고 쌓아놓은 거 한방에 터지는 구조'.",
    "lifeDirection": "인생 방향을 행동으로. 15~25자. 실패: '느리게 가면 더 많은 걸 얻음'. 성공: '남들 속도에 휩쓸리면 꼬이고, 혼자 느리게 가야 길이 열림'.",
