...

{
  ...
  "overview": {
    "_tone": "작업 순서: 상세 분석(personality.core, career.analysis 등)을 먼저 전부 쓴 다음, 각 상세의 핵심 결론을 overview 톤으로 변환. 톤: 친한 친구가 술자리에서 한마디 던지는 느낌. 찔리는데 웃겨서 억울하지 않음. 캡처해서 카톡으로 보내는 수준. 문체: 말하듯 툭 끊기. '작심3일', '폐인 확정', '밥 먹여주는 줄 암', '5분 만에 싸움', '통장 텅 빔'. ~임/~됨/~옴 금지. ~한다/~된다 금지. ~해요/~습니다 금지. 물음표 금지. 내용 생성법: (1) 상세 분석에서 이 사주의 핵심 결론을 뽑아 (2) 그 결론이 실제 일상에서 어떤 행동으로 나타나는지 변환 (3) 사주 용어는 0개. 행동 묘사만. (4) 다른 사주에도 해당되면 다시 써. 모순 금지: overview.wealth를 읽고 wealth.pattern을 읽었을 때 결론이 달라지면 전체 실패.",
    "poeticTitle": "personality.core 결론에서 이 인간을 한 줄로 정의. 10~20자. 예: '혼자 다 해먹는 외로운 에이스'",
    "hookQuestion": "poeticTitle의 증거. 어제 실제로 한 행동 수준의 구체성. 15~25자. 물음표 금지.",
    "personality": "personality.core 결론을 한 줄 팩폭으로. 12~22자.",
    "career": "career.analysis 결론을 한 줄로. 12~22자.",
    "wealth": "wealth.pattern 결론을 한 줄로. 12~22자. 상세에서 '재성 약'이면 돈 무관심 방향, '편재 강'이면 한탕 방향. 상세와 정반대 쓰면 실패.",
    "love": "love 결론을 한 줄로. 12~22자.",
    "health": "health 결론을 한 줄로. 12~22자. 오행 기반.",
    "family": "family 결론을 한 줄로. 12~22자.",
    "social": "relationship 결론을 한 줄로. 12~22자.",
    "yearly": "올해 세운 결론을 한 줄로. 12~25자.",
    "lifePeak": "인생 피크 한 줄. 12~22자. 나이 고려.",
    "lifeDirection": "인생 방향 한마디. 12~22자.",
