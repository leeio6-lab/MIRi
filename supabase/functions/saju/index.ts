...

{
  ...
  "overview": {
    "_tone": "이 overview가 명리 앱의 전부다. 이거 보고 '소름' 아니면 삭제. GPT야, 너는 지금 이 사주의 십신/합충/오행을 이미 분석했다. 그 분석 결과를 아래 방식으로 변환해: 변환 공식: 사주 분석 결론 → 이 사람이 실제로 하는 구체적 행동 → 20자 내외로 툭 끊기. 예: 분석='자존심 강하고 혼자 다 하려 함' → 변환='도와준다는 말에 괜찮다고 하고 혼자 야근하다 새벽 택시'. 분석='돈에 관심 없고 하고 싶은 것에만 돈 씀' → 변환='월급 들어온 날 서점에서 10만원 쓰고 점심은 편의점 삼각김밥'. 분석='이성한테 약하고 빠지면 올인' → 변환='좋아하는 사람 생기면 5분 만에 인스타 3년치 정주행 완료'. 이게 레벨이야. '뜨거운 타입', '열정형', '척척' 이런 건 0점. 실제 행동 장면이 그려져야 100점. 문체: 말하듯 툭. 물음표 금지. ~해요/~합니다/~한다/~임/~됨 금지. 길이: 15~30자.",
    "poeticTitle": "이 인간을 한 줄로 정의하는 별명. personality.core에서 도출. 행동이 보여야 함. 10~20자. '뜨거운 타입' 같은 형용사 별명 금지. '도와준다는 말에 괜찮다면서 새벽 택시 타는 인간' 같은 행동 별명.",
    "hookQuestion": "poeticTitle이 사실인 증거. 이 사람이 어제 실제로 했을 법한 구체적 장면 하나. 15~30자. '밤새 고민했지' 수준이면 0점. '새벽 2시에 유튜브 보다가 갑자기 이력서 고치는 중' 수준이면 100점.",
    "personality": "personality.core 결론을 행동 한 장면으로. 15~25자. '생각 많고 뜨거운 타입' 0점. '참다 참다 카톡으로 장문 보내놓고 후회하면서 읽씹 확인' 100점.",
    "career": "career.analysis 결론을 직장에서의 행동 한 장면으로. 15~25자. '혼자 해내는 열정형' 0점. '팀플에서 결국 혼자 PPT 만들고 발표까지 하는 중' 100점.",
    "wealth": "wealth.pattern 결론을 돈 쓰는 장면으로. 15~25자. 상세에서 재성 약하면 돈 무관심 방향. '무관심이 통장 텅 빔' 0점. '월급 들어온 날 쿠팡 3건 결제하고 다음날 잔액 확인하다 멘붕' 100점.",
    "love": "love 결론을 연애에서의 행동 한 장면으로. 15~25자. '불꽃놀이 같은 연애' 0점. '좋아하면 읽자마자 답장, 관심 없으면 3일 뒤에 읽씹' 100점.",
    "health": "health 결론을 몸이 보내는 신호 한 장면으로. 15~25자. '뜨거운 물 조심' 0점. '스트레스 받으면 제일 먼저 목이 뻣뻣해지고 두통' 100점.",
    "family": "family 결론을 가족과의 실제 장면 하나. 15~25자. '가족이 동아줄' 0점. '엄마 전화 안 받다가 죄책감에 10분 뒤 콜백' 100점.",
    "social": "relationship 결론을 친구관계 장면 하나. 15~25자. '혼자서도 척척' 0점. '약속 잡아놓고 당일 아침에 취소하고 싶은 거 참는 중' 100점.",
    "yearly": "올해 세운 결론을 올해 실제로 겪을 장면으로. 15~30자. '올해는 좀 더움' 0점. '올 하반기에 참았던 거 하나가 터지는데 터지고 나면 오히려 시원' 100점.",
    "lifePeak": "인생 피크를 행동으로. 15~25자. 나이 고려. '40대에 빛남' 0점. '40대에 그동안 쌓아놓은 거 한방에 터지는 구조' 100점.",
    "lifeDirection": "인생 방향을 행동 명령으로. 15~25자. '물 찾아야 함' 0점. '남들 따라가지 말고 느리더라도 혼자 가야 안 부서짐' 100점.",
