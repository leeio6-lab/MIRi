...

{
  ...
  "overview": {
    "_tone": "🔥 이 overview가 MIRI의 생존이 걸린 핵심이다. 목표: 유저가 결과 화면 캡처 → 카톡/인스타 스토리에 '이거 소름...' 하면서 올리는 것. 톤: 20~30대가 '아 ㅋㅋㅋ 찔린다' 또는 '소름 돋는다' 하는 수준의 정확한 팩폭. 무당 느낌 아님. 친한 형/누나가 술자리에서 정곡 찌르는 느낌. 웃기면서 찔리는 게 최고. 웃기기만 하면 가볍고, 찔리기만 하면 불쾌. ⚡ 문체: 반드시 '~함/~씀/~임/~됨/~봄/~감' 체로 끝내라. 트위터/인스타 감성의 축약형 반말. '~한다/~쓴다/~간다' 금지. 나쁜 예: '새벽 3시에 옛날 사진 보다가 전 연인 인스타까지 정주행한다' / 좋은 예: '새벽 3시에 옛날 사진 보다가 전 연인 인스타까지 정주행함'. 나쁜 예: '돈 쓸 때는 통 크게 쓰는데 택시비 아까워서 30분 걸어간다' / 좋은 예: '돈 쓸 때는 통 크게 쓰는데 택시비 아까워서 30분 걸어감'. 작성법: 이 사주의 십신/합충/오행에서만 나올 수 있는 구체적 행동을 묘사. '독립적임', '감성적임' 같은 형용사 금지. 행동으로 보여줘라. 나쁜 예: '감성이 풍부한 낭만주의자' / 좋은 예: '새벽에 옛날 사진 꺼내보다가 혼자 눈물 찔끔 흘림'. 나쁜 예: '리더십이 있음' / 좋은 예: '회의에서 결국 본인이 정리하고 끝내는데 공은 팀장이 가져감'. 각 항목은 읽는 사람이 '아 이거 나인데??' 하고 멈칫하는 수준이어야 함. 다른 사주에도 해당되는 말이면 실패. ⛔ 금지: ~해요/~습니다/~한다/~쓴다/~간다/~하는 체질/~하는 경향/물음표(?)/ㅋㅋ/ㅎㅎ/이모지/진지한 상담사 말투. ✅ 반드시 ~함/~씀/~임/~됨 체. 긍정(자랑하고 싶은 것) 50% + 부정(찔리는 것) 50%.",
    ...
    "hookQuestion": "poeticTitle이 사실인 증거. ~함/~씀/~임 체 단정문. 물음표 금지. 어제 실제로 한 행동 수준의 구체성. 이 사주의 십신 배치에서 논리적으로 나오는 행동이어야 함. (레벨 참고: '어제도 유튜브 알고리즘에 2시간 바침, 원래 5분만 보려 했음', '오늘 점심 뭐 먹을지 30분 고민하다가 결국 어제 먹은 거 또 먹음', '방금 카톡에 ㅇㅇ 치다가 지우고 장문 3줄로 다시 씀') 25~45자.",
    "personality": "성격 팩폭 or 자랑. ~함/~씀/~임 체. 형용사 금지, 구체적 행동으로. 이 사주의 비겁/식상/인성 배치에서 도출. (레벨 참고: '잘못 지적당하면 일단 인정하는데 속으로 반박문 3개 씀', '약속 시간 10분 전에 도착해놓고 상대가 1분 늦으면 짜증남') 25~40자.",
    "career": "직업 팩폭 or 자랑. ~함/~씀/~임 체. 관성/식상 배치에서 도출. (레벨 참고: '야근은 싫은데 퇴근 후에 본인 프로젝트는 새벽까지 함', '이력서 매달 업데이트하면서 이직은 3년째 안 함') 25~40자.",
    "wealth": "돈 팩폭 or 자랑. ~함/~씀/~임 체. 재성 구조에서 도출. (레벨 참고: '적금 3개 넣으면서 배달비에 월 20만 원 씀', '통장에 비상금 100만 원은 무조건 남겨놓는 불안형 저축러임') 25~40자.",
    "love": "연애 팩폭 or 자랑. ~함/~씀/~임 체. 관성/재성/비겁 관계에서 도출. (레벨 참고: '썸 탈 때는 밀당 고수인데 사귀면 하루 만에 올인함', '좋아하는 사람 앞에서만 갑자기 말수가 줄어드는 반전 있음') 25~40자.",
    "health": "건강 팩폭 or 자랑. ~함/~씀/~임 체. 오행 과다/부족에서 도출. (레벨 참고: '헬스 등록만 5번째인데 한번 가면 2시간 하는 극과 극임', '스트레스 받으면 일단 먹고 보는데 그게 새벽 라면임') 25~40자.",
    "family": "가족 팩폭 or 자랑. ~함/~씀/~임 체. 인성/비겁 구조에서 도출. (레벨 참고: '부모님 잔소리에 대꾸 안 하는데 방 들어가서 이불킥함', '명절에 조카들 챙기다 보면 에너지 다 빨리는 숨은 큰손임') 25~40자.",
    "social": "인간관계 팩폭 or 자랑. ~함/~씀/~임 체. 비겁/식상/관성에서 도출. (레벨 참고: '단톡방에서 읽씹 전문인데 1:1이면 새벽까지 상담해줌', '모임 끝나면 집 가는 길에 오늘 한 말 복기하느라 지침') 25~40자.",
    "yearly": "올해 한 줄 예언. ~함/~씀/~임 체. 세운과 원국의 구체적 작용에서 도출. (레벨 참고: '올해 상반기에 뭔가 하나 터지는데, 기회인지 사고인지는 본인 선택임', '하반기에 내린 결정 하나가 내년 수입을 좌우함') 25~40자.",
    "lifePeak": "인생 그래프 핵심. ~함/~씀/~임 체. 나이 고려하여 시제. 대운 흐름 근거. (레벨 참고: '30대 후반부터 돈이 손에 잡히기 시작함, 지금은 실력 쌓는 시간임', '이미 피크는 지났는데 두 번째 피크가 50대에 옴') 25~40자.",
    "lifeDirection": "인생 방향 한 줄. ~함/~씀/~임 체 또는 명령문. 액자에 넣고 싶은 급. 용신 오행에서 도출. (레벨 참고: '안전한 길은 네 길 아님, 좀 무서운 쪽으로 가야 됨', '혼자 하려고 하지 마, 네 운은 사람에게서 옴', '빨리 가려 하지 마, 천천히 가는 게 네 속도임') 25~40자.",
