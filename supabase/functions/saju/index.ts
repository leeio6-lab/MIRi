...

{
  ...
  "overview": {
    "_tone": "🔥 읽는 순간 '어 이거 나인데' 하고 소름 돋는 한 줄. 뼈 때리는 팩폭인데 웃겨서 억울하지 않음. 캡처해서 친구한테 보내는 수준. ⚡ 종결 문체: 자연스러운 구어체 종결. '~임' '~옴' '~됨' '~씀' '~짐' 금지. 대신 자연스럽게 끊기: '작심3일', '폐인 확정', '밥 먹여주는 줄 암', '혼자 삭힘', '영혼 빠져나감', '통장 텅 빔', '5분 만에 싸움'. 말하듯 툭 끊거나, 단정적 서술('~확정', '~수준', '~그 자체')로 마무리. ⛔ 금지: ~한다/~된다/~있다/~없다 (하다체), ~해요/~습니다(존댓말), ~임/~됨/~옴(딱딱한 명사형), 물음표, 이모지, ~경향/~체질/~타입(설명체). 🚨 내용: 아래 상세 분석 결론을 이 톤으로 변환. 상세와 모순 시 전체 실패.",
    "poeticTitle": "이 인간 한 줄 정의. 10~20자. personality.core에서. 톤 참고만: '혼자 다 해먹는 외로운 에이스', '입보다 주먹이 먼저 나가는 불도저'",
    "hookQuestion": "poeticTitle의 증거가 되는 구체적 상황. 15~25자. 물음표 금지. 톤 참고만: '새벽 2시에 보낸 카톡 후회하면서 또 보내는 중', '퇴근하고 집 앞인데 차에서 30분째 멍'",
    "personality": "personality.core 결론을 팩폭 한 줄로. 12~22자. 톤 참고만: '착한 척하다 뒤에서 혼자 속 삭힘', '자존심이 밥 먹여주는 줄 암', '참다 터지면 주변 초토화'",
    "career": "career.analysis 결론을 한 줄로. 12~22자. 톤 참고만: '재능은 있는데 꾸준함은 작심3일', '남 밑에서 일하면 영혼 빠져나감', '능력은 되는데 자리가 안 따라줌'",
    "wealth": "wealth.pattern 결론을 한 줄로. 12~22자. 🚨 상세에서 '재성 약'→돈 무관심 방향. '편재 강'→한탕 방향. 정반대 쓰면 실패. 톤 참고만: '월급 들어오면 증발, 어디 갔는지 본인도 모름', '돈 앞에서 이성 증발', '아끼는 건 잘하는데 버는 재주가 없음'",
    "love": "love 결론을 한 줄로. 12~22자. 톤 참고만: '좋아하면 자다가도 벌떡 일어남', '이별 후 6개월은 폐인 확정', '썸만 100번, 연애는 0번'",
    "health": "health 결론을 한 줄로. 12~22자. 오행 기반. 톤 참고만: '멘탈 나가면 몸이 바로 따라 무너짐', '위장이 스트레스 측정기', '잠 줄이면 제일 먼저 얼굴에 다 나옴'",
    "family": "family 결론을 한 줄로. 12~22자. 톤 참고만: '효도하고 싶은데 만나면 5분 만에 싸움', '집에서 제일 속 썩이면서 제일 걱정도 끼침', '가족 앞에서만 유독 솔직해져서 탈'",
    "social": "relationship 결론을 한 줄로. 12~22자. 톤 참고만: '팔로워 500인데 생일 축하 문자 3개', '만나면 재밌는데 먼저 연락은 절대 안 함', '소수 정예인 척, 사실 그냥 귀찮음'",
    "yearly": "올해 세운 결론을 한 줄로. 12~25자. 세운+원국 근거. 톤 참고만: '올해 참으면 내년에 두 배로 돌려받음', '상반기에 뿌린 거 하반기에 예상 못한 형태로 터짐', '올해 만난 인연 하나가 인생 바꿔놓음'",
    "lifePeak": "인생 피크 한 줄. 12~22자. 나이 고려. 톤 참고만: '진짜 전성기 아직 안 왔고, 40대에 뒤집어짐', '한번 터졌고 두 번째가 슬슬 오는 중', '지금이 인생 하이라이트, 여기서 밀어야 됨'",
    "lifeDirection": "인생 방향 한마디. 12~22자. 톤 참고만: '계획대로 안 되는 게 오히려 정답인 팔자', '남 눈치 보는 순간 다 꼬임', '느려도 내 속도로 가야 안 부서짐'",
