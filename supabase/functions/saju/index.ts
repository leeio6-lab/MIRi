...
□ overview에 질문형('~죠?' '~맞죠?' '~있죠?')이 없는가? (있으면 실패, 전부 단정문으로)
...

{
  ...
  "overview": {
    "_tone": "🔥 overview는 캡처해서 카톡에 올리고 싶을 정도로 자극적이어야 한다. 반말(~다/~중/~패턴/~유형). 절대 ~해요/~어요/~습니다 쓰지 마라. 짧고 강한 펀치라인. 뻔하면 삭제. '~하는 체질' '~할 수 있어요' '~하는 경향' 금지. 질문형(~죠?) 금지. 친구가 술자리에서 팩트로 후드려패는 톤. 이 사주에서만 나올 수 있는 날카로운 한 줄.",
    "poeticTitle": "이 사주를 한 마디로 때리는 킬러 별명. 반말. 인스타 프로필에 바로 박을 수준. 예시 복사 금지. (톤: '착한 척 하다 폭발하는 감정 시한폭탄', '퇴사 각서 3번 쓰고 아직 출근하는 비겁한 천재', '연애하면 IQ 30 되는 만년 호구', '돈 앞에서만 냉철해지는 감성 사기꾼') 15~25자.",
    "hookQuestion": "poeticTitle 보충. 이 사람이 지금 하고 있을 행동을 콕 찍는다. 반말 단정문. 물음표 금지. (톤: '지금도 카톡 읽씹당하고 속으로 뒤집어지는 중', '어제도 새벽 3시에 퇴사 후 인생 계획표 짜다 잠들었다', '좋아하는 사람 인스타 5분마다 확인하면서 먼저 연락은 절대 안 한다') 20~35자.",
    "personality": "성격의 급소를 반말로 때려라. (톤: '겉은 쿨한데 속으로 3일째 곱씹는 중', '착한 게 아니라 싸우기 싫은 것뿐인 회피형', '혼자 결정 다 해놓고 물어본 척하는 독재자') 20~35자.",
    "career": "직업/일 팩트폭격. 반말. (톤: '퇴사 각오 매일 하면서 10년째 출근 중', '능력은 임원급인데 정치력 0이라 만년 대리', '이직사이트 매일 켜놓고 지원은 안 하는 3년째') 20~35자.",
    "wealth": "돈 팩트. 반말. (톤: '월급 들어오면 3일 안에 증발하는 통장 보유자', '남한테는 통 크면서 본인 밥값은 아까워하는 호구 DNA', '재테크 유튜브 구독 200개, 실행 0') 20~35자.",
    "love": "연애 팩트. 반말. 전 애인이 떠오르게. (톤: '매번 안 되는 놈한테 올인하고 되는 놈은 밀어내는 저주', '3개월 불꽃 → 6개월 권태 → 이별 후 후회, 이 사이클 무한반복', '본인이 차놓고 상대가 잘 되면 미쳐버리는 유형') 20~35자.",
    "health": "몸 경고 팩트. 반말. (톤: '스트레스 받으면 위장이 먼저 뒤집어지는 타입', '잠 줄여가며 버티다가 어느 날 쓰러질 각', '운동해야 하는 거 알면서 내일부터를 365일째 반복 중') 20~35자.",
    "family": "가족 팩트. 반말. (톤: '사랑하는데 표현 못해서 매번 싸우는 불통 가족', '부모님 전화 3초 고민하고 결국 받는 사이', '명절마다 참다가 집에 와서 베개에 소리 지르는 패턴') 20~35자.",
    "social": "인간관계 팩트. 반말. (톤: '단톡방 50개인데 진짜 내 편은 0명인 가짜 인싸', '뒤에서 욕하는 거 다 알면서 웃으며 넘기는 프로 을', '모임 나가면 에너자이저인데 집 오는 길에 방전') 20~35자.",
