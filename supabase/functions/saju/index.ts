...

{
  ...
  "overview": {
    "_tone": "🔥 MIRI 바이럴 핵심. 캡처→카톡/인스타 공유 목표. 톤: 친한 형/누나가 술자리에서 정곡 찌르는 팩폭. 웃기면서 찔리는 게 최고. ⚡ 문체: 축약형 반말. '~함/~씀/~임/~됨' 또는 명사로 툭 끊기. '~한다/~쓴다/~간다' 금지. 🚨🚨🚨 최우선 규칙: overview 각 항목은 반드시 아래 상세 분석(personality.core, career.analysis, wealth.pattern, love, health 등)의 핵심 결론을 축약한 것이어야 한다. 상세 분석을 먼저 완성한 뒤, 그 결론을 overview 톤으로 변환하라. overview와 상세 분석이 모순되면 전체 응답 무효. 예: wealth.pattern에서 '재성이 약해 돈에 관심 없다'고 했으면 overview.wealth도 반드시 '돈에 관심 없는' 방향이어야 한다. '가계부에 적는 타입'처럼 정반대를 쓰면 실패. ⛔ 금지: ~해요/~습니다/~한다/~하는 체질/~하는 경향/물음표/이모지/상담사 말투. ✅ 긍정 50% + 부정 50%.",
    "poeticTitle": "킬러 별명. 10~20자. personality.core의 핵심을 축약. 🚨 괄호 안은 톤 참고용이지 복사 금지. (비겁 강→'혼자 다 하는 외로운 에이스', 식상 강→'입이 먼저 움직이는 아이디어 폭격기', 재성 강→'돈 냄새 귀신같이 맡는 현실주의자')",
    "hookQuestion": "poeticTitle의 증거. personality.core에서 도출한 행동. 축약형 반말. 물음표 금지. 15~25자.",
    "personality": "personality.core의 핵심 결론을 12~22자로 축약. 상세 분석과 반드시 동일한 결론.",
    "career": "career.analysis의 핵심 결론을 12~22자로 축약. 상세 분석과 반드시 동일한 결론.",
    "wealth": "wealth.pattern의 핵심 결론을 12~22자로 축약. 🚨 상세에서 '재성 약하다'고 했으면 '돈에 관심 없음' 방향. '편재 강하다'고 했으면 '한탕' 방향. 상세와 정반대 쓰면 실패.",
    "love": "love의 핵심 결론을 12~22자로 축약. 상세 분석과 반드시 동일한 결론.",
    "health": "health의 핵심 결론을 12~22자로 축약. 오행 과다/부족 기반. 상세와 일치.",
    "family": "family의 핵심 결론을 12~22자로 축약. 상세 분석과 반드시 동일한 결론.",
    "social": "대인관계 묘사. 12~22자. 🚨 톤 참고만. (식상 강→'아는 사람은 많은데 깊은 친구 적음', 비겁 강→'혼자가 편한데 외로움은 탐', 인성 강→'소수 정예 관계만 유지')",
    "yearly": "올해 한 줄. 12~25자. 세운+원국 작용 근거. 🚨 톤 참고만. (세운이 용신→'올해는 바람 타는 해', 세운이 기신→'참는 연습하는 해', 세운 합→'뭔가 엮이는 해')",
    "lifePeak": "인생 피크. 12~22자. 나이 고려 시제. 🚨 톤 참고만. (피크 대운 아직→'40대부터 진짜 시작', 피크 대운 지남→'이미 한번 터졌고 두 번째 올 차례', 지금이 피크→'지금이 제일 좋은 시기, 밀어')",
    "lifeDirection": "인생 방향. 명령문 OK. 12~22자. 🚨 톤 참고만. (용신 수→'흐르는 대로 가, 막으면 넘침', 용신 화→'뜨겁게 질러, 미지근하면 꺼짐', 용신 토→'묵묵히 쌓아, 급하면 무너짐')",
