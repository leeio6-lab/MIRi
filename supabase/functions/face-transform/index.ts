...

{
  ...
  "features": [
    ...
    {"area":"eyes", "score":(60-95), "nickname":"(자극적 — 용안/봉황안/재벌가의 눈/아이돌 눈/카리스마 눈)", "description":"(감찰관監察官 기반 핵심 한줄. '얼굴 천 냥 눈 구백 냥' 인용)", "detail":"(①눈의 형태와 분류 (용안/봉황안/학안/호안 등) ②동자의 밝기와 흑백 비율 → 정신력과 부귀 판별 ③눈꼬리 방향 → 처첩궁(배우자운) 직결 ④눈 아래 와잠 → 남녀궁(자녀운) ⑤이 눈이 가져올 인생 반전 시기와 기회. 180자 이상)"},
