---
name: miri-design
description: MIRI 앱 디자인 시스템. UI/디자인 작업 시 반드시 참조. 컬러, 타이포, 카드, 애니메이션, 금지 목록 등 모든 디자인 원칙 포함. 새로운 컴포넌트, 화면, 스타일 수정 시 이 스킬을 적용.
license: MIT
metadata:
  author: leeio6-lab
  version: "1.0.0"
...
MIRI(미리)는 3,000년 동양 역학과 현대 AI가 만나는 앱.
"미리 알다"의 미리이자, 자신을 비추는 "mirror".
태그라인: **"운명을 미리 보다"**
